    ...
    <div className='flex flex-col gap-4 h-full w-2/3 max-w-[700px] justify-center'>
        ...
        <div className='mt-8 '>
            ...
            <div className='mt-8 flex flex-col gap-y-4'>
                <button className='active:scale-[.98] active:duration-75 transition-all hover:scale-[1.01] ease-in-out transform py-4 bg-color-cream rounded-xl text-black font-bold text-lg'>
                    {
