...
from controllers.chats_controller import get_chats, save_message, create_chat, rename_chat, answer_and_save_message, remove_chat, append_pdf, pop_pdf, list_chats

from flask_jwt_extended import jwt_required, request, jsonify, get_jwt_identity, current_app
...
def append_pdf_route():
    ...
    chat_name = request.form.get('id_chat')
    ...
    return append_pdf(chat_name, pdf_file)
